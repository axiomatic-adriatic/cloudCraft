...
-- group data
INSERT INTO `channels` (`channel_id`, `channel_name`) VALUES (1, 'Aiden Avery');
...
INSERT INTO `users_channels` (`user_channel_id`, `user_id`, `channel_id`, `type`) VALUES (8, 7, 3, 'direct');
...
INSERT INTO `messages` (`message_id`,`user_id`,`channel_id`,`read`,`datetime`,`message_text`,`disabled`,`completed`,`is_delete`) VALUES(3,7,1,1,"2020-10-16 15:14:41","semper. Nam tempor diam dictum sapien. Aenean massa. Integer vitae",0,1,0);
...
INSERT INTO `messages` (`message_id`,`user_id`,`channel_id`,`read`,`datetime`,`message_text`,`disabled`,`completed`,`is_delete`)VALUES(7,4,5,1,"2020-05-30 13:19:23","mi. Duis risus odio, auctor vitae, aliquet nec, imperdiet nec,",1,0,0);
INSERT INTO `messages` (`message_id`,`user_id`,`channel_id`,`read`,`datetime`,`message_text`,`disabled`,`completed`,`is_delete`)VALUES(8,8,5,0,"2020-09-18 19:55:25","Aliquam auctor, velit eget laoreet posuere, enim nisl elementum purus,",0,1,0);
